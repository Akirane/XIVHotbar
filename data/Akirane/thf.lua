...
xivhotbar_keybinds_job['Base'] = {
	...
	{'b 3 11',  'ja', 'collaborator', 'stal' ,'col.'},
	{'b 3 12',  'ja', 'accomplice', 'stal' ,'acc.' },

	{'b 2 10',  'gs', 'equip engaged[\'Hybrid\']', '', 'hybr.'},
	{'b 3 10',  'gs', 'equip engaged', '' ,'Engaged'},
	{'b 4 12',  'gs', 'equip engaged[\'ERegen\']', '' ,'EReg.'},
