...
xivhotbar_keybinds_job['Base'] = {
  ...
  {'battle 4 7', 'gs', 'equip engaged[\'DT\']', '', 'DT'},
  {'battle 4 8', 'gs', 'equip engaged', '', 'DPS'},
  {'battle 4 9', 'ja', 'vivacious pulse', 'me', 'Pulse', 'pulse-icon'},
  {'battle 4 0', 'ja', 'One for All', 'me', 'OFA', 'shellra'},
  {'battle 5 5', 'ws', 'fell cleave', 'stnpc', 'FC'},
  {'battle 5 8', 'gs', 'equip idle', '', 'MDef'},
  {'battle 5 9', 'gs', 'equip magic_def', '', 'MDef'},
  {'b 5 0', 'item',  "Dusty Wing", 'me', 'Wing'},
